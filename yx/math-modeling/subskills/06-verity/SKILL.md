---
name: 06-verity
description: "数学建模竞赛最终验证和验收阶段。用于论文写完后按实际项目结构检查 md 章节数量、标题顺序、图表引用、数值一致性、占位符、内部文件泄露、参考文献、代码可复现性、md 文档和提交就绪状态。"
...
- 本阶段负责：结构验收、文本质量门禁、图表引用检查、结果一致性检查、md 文档检查、提交清单。
...
- 不要把模板结构误删成普通空白 md 文档。

### Step 7: 论文正文检查

论文 md 正文生成后，详细检查（通过 md 预览确认视觉布局）：
